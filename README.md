# AutomatedCookieClicker

Automated Cookie Clicker is a bot that uses Python's Selenium WebDriver API to play the Cookie Clicker from https://orteil.dashnet.org/cookieclicker/ instead of you.
